                            ...
                            <div class="relative h-56 overflow-hidden rounded-lg">
                                ${post.event && post.event.thumbnail ? `
                                    <div class="duration-700 ease-in-out flex items-center justify-center w-full h-full" data-carousel-item>
                                        <img src="storage/posts/thumbnails/${post.event.thumbnail}" class="max-w-full max-h-full object-cover rounded-md" alt="Post Image">
                                    </div>
                                ` : ''}

                                ${post.news && post.news.thumbnail ? `
                                    <div class="duration-700 ease-in-out flex items-center justify-center w-full h-full" data-carousel-item>
                                        <img src="storage/posts/thumbnails/${post.news.thumbnail}" class="max-w-full max-h-full object-cover rounded-md" alt="Post Image">
                                    </div>
                                ` : ''}

                                ${post.announcement && post.announcement.thumbnail ? `
                                    <div class="duration-700 ease-in-out flex items-center justify-center w-full h-full" data-carousel-item>
                                        <img src="storage/posts/thumbnails/${post.announcement.thumbnail}" class="max-w-full max-h-full object-cover rounded-md" alt="Post Image">
                                    </div>
                                ` : ''}
