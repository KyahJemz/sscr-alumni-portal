                    ...
                    <form action="{{ route('posts.update', ['post' => $post->id]) }}" method="post" enctype="multipart/form-data" class="flex gap-4">
                        ...
                        <div class="w-full space-y-2">
                            ...
                            <div id="news-announcement-form" class="w-full hidden space-y-2">
                                <input type="text" name="title" class="w-full p-2 rounded" value="{{optional($post->news)->title ?? optional($post->announcement)->title ?? optional($post->event)->title ?? ''}}" placeholder="Title... *">
                            ...
                            <div id="event-form" class="w-full hidden space-y-2">
                                <input type="text" name="location" class="w-full p-2 rounded -mt-2"
                                    placeholder="Event location..." value="{{optional($post->event)->location ?? ''}}">
                            ...
                            <div id="thumbnail-form" class="w-full hidden space-y-2">
                                ...
                                <input id="thumbnail-upload" type="file" name="thumbnail"
                                    class="w-full p-2 rounded -mt-2" placeholder="Thumbnail" accept="image/*" value="{{optional($post->news)->thumbnail ?? optional($post->announcement)->thumbnail ?? optional($post->event)->thumbnail ?? ''}}">
