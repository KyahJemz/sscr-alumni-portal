...
<div id="filters" class="flex justify-between w-full">
    ...
    <a class="bg-sscr-red text-white rounded-md h-max py-2 px-4 inline-flex items-center text-xs cursor-pointer" onclick="exportTable('group-members-approval-table-body')">Export Table</a>
</div>
