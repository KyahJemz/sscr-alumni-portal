<nav x-data="{ open: false }" class="bg-sscr-red dark:bg-sscr-red border-b border-gray-200 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative">
        <div class="flex w-full justify-between h-max py-4 sm:py-2 px-2">
            ...
            <div class="flex sm:flex shrink-0 flex-1 items-center text-center flex-col">
                <p class="sm:text-3xl text-md text-sscr-yellow dark:text-sscr-yellow">San Sebastian College - Recoletos de Cavite</p>
